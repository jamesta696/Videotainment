class ChannelItem {
        ...
        <div class="column-in-channels channel-no-0" style="width: 142px; height:142px;">
            <div class="card-channel">
                <a href="/channel.html?id=${data.snippet.channelId}">
                    <div class="channel-image" style="background-image: url(${
                        data.snippet.thumbnails.high.url
                    })"></div>
                </a>
                <h3 class="card-title"><a href="/channel.html?id=${
                    data.snippet.channelId
                }">${data.snippet.channelTitle}</a></h3>
    ...
    setChannelDetails(data) {
        let thumbNailContainer = this.element.querySelector(
            ".image-round .image-channel"
        );
